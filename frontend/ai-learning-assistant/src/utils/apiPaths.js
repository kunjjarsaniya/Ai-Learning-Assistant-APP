...
export const API_PATHS = {
    ...
    PROGRESS: {
        ...
        GET_INSIGHTS: "/api/progress/insights",
    },

    STUDY_PLANS: {
        GENERATE: "/api/study-plans",
        GET_ALL: "/api/study-plans",
        GET_BY_ID: (id) => `/api/study-plans/${id}`,
        DELETE: (id) => `/api/study-plans/${id}`,
        UPDATE_TOPIC: (id, topicId) => `/api/study-plans/${id}/topics/${topicId}`,
    },

    MIND_MAPS: {
        GENERATE: "/api/mind-maps",
        GET_ALL: "/api/mind-maps",
        GET_BY_ID: (id) => `/api/mind-maps/${id}`,
        DELETE: (id) => `/api/mind-maps/${id}`,
    },
};